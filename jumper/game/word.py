import random  
list = ['apple', 'banana', 'orange', 'pear','pineapple', 'strawberry', 'watermelon','dragonfruit', 'grapefruit', 'kiwi', 'lemon', 'lime', 'mango', 'melon', 'nectarine', 'peach', 'plum', 'pomegranate', 'raspberry', 'tangerine', 'tomato', 'watermelon', 'watermelon', 'audi', 'toyota',"haphazard", "hyphen", "iatrogenic", "icebox", "jackpot", "jaundice", "jawbreaker",
